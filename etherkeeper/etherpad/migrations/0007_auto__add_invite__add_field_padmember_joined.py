...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'etherpad', ['Invite'])

        # Adding field 'PadMember.joined'
        db.add_column(u'etherpad_padmember', 'joined',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'etherpad_invite')

        # Deleting field 'PadMember.joined'
        db.delete_column(u'etherpad_padmember', 'joined')
    ...
    models = {
        ...
        u'etherpad.invite': {
            ...
            'sent': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 0, 0)'}),
        ...
        u'etherpad.padmember': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joined': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 0, 0)'}),
            'pad': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['etherpad.Pad']", 'unique': 'True'}),
            'role': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
