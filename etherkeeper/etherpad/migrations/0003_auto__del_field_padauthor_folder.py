...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PadAuthor.folder'
        db.delete_column(u'etherpad_padauthor', 'folder_id')


    def backwards(self, orm):
        # Adding field 'PadAuthor.folder'
        db.add_column(u'etherpad_padauthor', 'folder',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organize.Folder'], null=True),
                      keep_default=False)
